...
class JsCompiler extends \Twig_Compiler
{
    ...
    public function __construct(\Twig_Environment $env)
    {
        ...
        $this->typeCompilers = array(
            ...
            \Twig\Node\Node::class => new NodeCompiler(),
            \Twig\Node\BodyNode::class => new BodyCompiler(),
            \Twig\Node\ModuleNode::class => new ModuleCompiler\GoogleCompiler(),
            \Twig\Node\BlockNode::class => new BlockCompiler(),
            \Twig\Node\TextNode::class => new TextCompiler(),
            ...
            \Twig\Node\SpacelessNode::class => new SpacelessCompiler(),
            \Twig\Node\SetTempNode::class => new SetTempCompiler(),
            \Twig_Node_Expression_ExtensionReference::class => new ExtensionReferenceCompiler(),
            \Twig\Node\BlockReferenceNode::class => new BlockReferenceCompiler(),
            ...
            \Twig\Node\Expression\FunctionExpression::class => new FunctionCompiler(),
            \Twig\Node\Expression\ParentExpression::class => new ParentCompiler(),
            \Twig\Node\Expression\BlockReferenceExpression::class => new ExpressionBlockReferenceCompiler(),
            \Twig\Node\Expression\AssignNameExpression::class => new AssignNameCompiler(),
            \Twig\Node\Expression\TestExpression::class => new TestCompiler(),
            \Twig\Node\Expression\NameExpression::class => new NameCompiler(),
            \Twig\Node\Expression\FilterExpression::class => new FilterCompiler(),
            \Twig\Node\Expression\Filter\DefaultFilter::class => new Compiler\Expression\Filter\DefaultCompiler(),
            \Twig\Node\Expression\ConstantExpression::class => new ConstantCompiler(),
            \Twig\Node\Expression\GetAttrExpression::class => new GetAttrCompiler(),
            \Twig\Node\Expression\MethodCallExpression::class => new Compiler\Expression\MethodCallCompiler(),
            \Twig\Node\Expression\Binary\AddBinary::class => new AddCompiler(),
            \Twig\Node\Expression\Binary\AndBinary::class => new AndCompiler(),
            \Twig\Node\Expression\Binary\BitwiseAndBinary::class => new BitwiseAndCompiler(),
            \Twig\Node\Expression\Binary\BitwiseOrBinary::class => new BitwiseOrCompiler(),
            \Twig\Node\Expression\Binary\BitwiseXorBinary::class => new BitwiseXorCompiler(),
            \Twig\Node\Expression\Binary\ConcatBinary::class => new ConcatCompiler(),
            \Twig\Node\Expression\Binary\DivBinary::class => new DivCompiler(),
            \Twig\Node\Expression\Binary\EqualBinary::class => new EqualCompiler(),
            \Twig\Node\Expression\Binary\FloorDivBinary::class => new FloorDivCompiler(),
            \Twig\Node\Expression\Binary\GreaterBinary::class => new GreaterCompiler(),
            \Twig\Node\Expression\Binary\GreaterEqualBinary::class => new GreaterEqualCompiler(),
            \Twig\Node\Expression\Binary\InBinary::class => new InCompiler(),
            \Twig\Node\Expression\Binary\LessBinary::class => new LessCompiler(),
            \Twig\Node\Expression\Binary\LessEqualBinary::class => new LessEqualCompiler(),
            \Twig\Node\Expression\Binary\ModBinary::class => new ModCompiler(),
            \Twig\Node\Expression\Binary\MulBinary::class => new MulCompiler(),
            \Twig\Node\Expression\Binary\NotEqualBinary::class => new NotEqualCompiler(),
            \Twig\Node\Expression\Binary\NotInBinary::class => new NotInCompiler(),
            \Twig\Node\Expression\Binary\OrBinary::class => new OrCompiler(),
            \Twig\Node\Expression\Binary\PowerBinary::class => new PowerCompiler(),
            \Twig\Node\Expression\Binary\RangeBinary::class => new RangeCompiler(),
            \Twig\Node\Expression\Binary\SubBinary::class => new SubCompiler(),
            \Twig\Node\Expression\Unary\NegUnary::class => new NegCompiler(),
            \Twig\Node\Expression\Unary\NotUnary::class => new NotCompiler(),
            \Twig\Node\Expression\Unary\PosUnary::class => new PosCompiler(),
            \Twig\Node\Expression\Test\ConstantTest::class => new Compiler\Expression\Test\ConstantCompiler(),
            \Twig\Node\Expression\Test\DefinedTest::class => new Compiler\Expression\Test\DefinedCompiler(),
            \Twig\Node\Expression\Test\DivisiblebyTest::class => new Compiler\Expression\Test\DivisiblebyCompiler(),
            \Twig\Node\Expression\Test\EvenTest::class => new Compiler\Expression\Test\EvenCompiler(),
            \Twig\Node\Expression\Test\NullTest::class => new Compiler\Expression\Test\NullCompiler(),
            \Twig\Node\Expression\Test\OddTest::class => new Compiler\Expression\Test\OddCompiler(),
            \Twig\Node\Expression\Test\SameasTest::class => new Compiler\Expression\Test\SameasCompiler(),
        );
